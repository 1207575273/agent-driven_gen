...
console.log(`[ports] 后端 -> http://localhost:${backendPort}  前端 -> http://localhost:${frontendPort}`);
...
run(`uv run --directory apps/back uvicorn app.main:app --reload --port ${backendPort}`, {});
